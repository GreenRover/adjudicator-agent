...
public class EvaluationConstants {
    ...
    // Castling bonuses
    public static final int MG_CASTLING_RIGHT_BONUS = 45;
    public static final int EG_CASTLING_RIGHT_BONUS = 0;

    public static final int MG_HAS_CASTLED_BONUS = 100;
    public static final int EG_HAS_CASTLED_BONUS = 0;
    ...
    // Centrality
    public static final int MG_CENTRALITY_BONUS = 15;
    public static final int EG_CENTRALITY_BONUS = 10;

    // Blocking (King safety) - mostly MG
    public static final int MG_BLOCKING_PENALTY = 50;
    public static final int EG_BLOCKING_PENALTY = 0;
